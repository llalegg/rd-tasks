...
export const prototypeTasks = [
  ...
  },
  {
    ...
    description: "Complete quarterly performance review for all athletes",
    type: "assessment",
    status: "completed",
    priority: "high",
    deadline: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
    ...
    relatedAthleteIds: ["athlete1", "athlete2", "athlete3"]
  },
  {
    id: "task12",
    name: "Equipment Maintenance Check",
    description: "Monthly equipment maintenance and safety check",
    type: "maintenance",
    status: "completed",
    priority: "medium",
    deadline: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
  ...
  {
    id: "task13",
    name: "Medical Clearance Forms",
    description: "Process medical clearance forms for new season",
    type: "medical",
    status: "completed",
    priority: "high",
    deadline: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000),
  ...
  },
  {
    ...
    description: "Organize team building event for athletes",
    type: "event",
    status: "completed",
    priority: "low",
    deadline: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
    ...
    relatedAthleteIds: ["athlete1", "athlete2", "athlete3", "athlete4", "athlete5"]
  },
  {
    id: "task15",
    name: "Training Video Analysis",
    description: "Analyze training videos for technique improvement",
    type: "analysis",
    status: "completed",
    priority: "medium",
    ...
    relatedAthleteIds: ["athlete1", "athlete3"]
  }
];
